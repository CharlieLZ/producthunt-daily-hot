...
榜单会在每天下午4点自动更新，可以在 [🌐 这里查看](https://producthunt.ai/)。
...
- **Markdown 文件生成**：生成包含产品数据的 Markdown 文件，方便在网站或其他平台上发布。
...
- 如果 API 请求失败，请检查您的令牌是否正确配置在 GitHub Secrets 中。
- 对于 WordPress 发布问题，请验证您的 WordPress 凭证和 API 访问权限。
